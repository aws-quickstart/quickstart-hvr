...
//TODO Tony, Neither of these paragraphs seems like troubleshooting. If they are, please state the problem first, then the action to take. Otherwise, delete this "Troubleshooting" heading and move this info to wherever it's germane to what people are reading and doing.